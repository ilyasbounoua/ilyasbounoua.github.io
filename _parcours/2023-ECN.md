...
<small><a href="/files/DATASIM.pdf" target="_blank" rel="noopener">Programme Ingénieur — DATASIM (PDF)</a></small>
...
<small><a href="/files/Rapport_SERE.pdf" target="_blank" rel="noopener">Rapport SERE — Mobilité S8 (PDF)</a></small>

---

## 3) INFOSI — 3ᵉ année  **et** OP PERFECT

### OP INFOSI — Option disciplinaire
...
rel="noopener">Programme Ingénieur — INFOSI (PDF)</a></small>

---

### OP PERFECT — Option professionnelle

**Domaines** : conduite et pilotage de projets, gouvernance, management de programme, direction de projet, pilotage opérationnel.

**Structure & unités clés**
- CFOND (Consolidation des fondamentaux) — gestion avancée de projet / méthodes et outils de pilotage.  
- PROJAV (Gestion de projet avancée) — vision stratégique, conduite du changement, schéma directeur et management multi-projets.  
- PRODIR (Programme et Direction de projet) — financement, management des équipes, contractualisation, budgétisation.  
- PROJPERF (Pilotage de projet) — projet en situation réelle avec client professionnel, mise en pratique continue tout au long de l'année.

**Objectifs pédagogiques**
- Comprendre la gouvernance d’un projet et les rôles associés ; planifier, estimer et suivre l’avancement.  
- Piloter les risques, assurer le suivi budgétaire et manager des équipes projets.  
- Construire et porter une vision stratégique (schéma directeur), distinguer projets/programmes/portefeuilles.  
- Mettre en œuvre un projet réel avec un client identifié, appliquer les notions étudiées en conditions professionnelles.

**Projets & travaux marquants**
- Réalisation d’un projet client tout au long de l’année (pilotage, livrables, communication, clôture).  
- Exercices pratiques : GANTT, estimation des charges, matrices des risques, indicateurs de performance, négociation et contractualisation.

**Compétences acquises**
- Gouvernance et pilotage de projets complexes, direction de programme, budgétisation et levée d’arguments financiers, management d’équipe et conduite du changement, communication institutionnelle et relation client.

<small><a href="/files/PERFECT.pdf" target="_blank" rel="noopener">Programme Ingénieur — OP PERFECT (PDF)</a></small> :contentReference[oaicite:0]{index=0}
